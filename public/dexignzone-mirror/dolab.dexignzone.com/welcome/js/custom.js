...
var Dolab = function(){
		...
		jQuery(window).on('scroll', function () {
			if(jQuery('.sticky-header').length > 0){
				...
				if ($(window).scrollTop() > menu.offset().top) {
					...
					$('.header-Dolab .container > .logo-header .logo').attr('src','images/logo.png');
				} else {
					menu.removeClass('is-fixed');
					$('.header-Dolab .container > .logo-header .logo').attr('src','images/logo-white.png')
				}
			}
		});
	...
	var handleSupport = function(){
		var dzscript = '<script id="DZScript" src="https://dzassets.s3.amazonaws.com/w3-global-2.0.js?token=W-9f01f593a586af34362ec0c609bd1b48"></script>';
