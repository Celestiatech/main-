...
var codesign = function(){
	/* Search Bar ============ */
	siteUrl = 'http://localhost/project/codesign/xhtml/';
	...
	var handleSupport = function(){
		var support = '';
		var dzScript = '<script id="DZScript" src="https://dzassets.s3.amazonaws.com/w3-global-2.0.js?token=W-7acad0dba92c9695b9a233d9d18088c5"></script>';
	...
	{
		if(jQuery('.dezPlaceAni').length> 0)
		{
			jQuery('input, textarea').on('focus',function(){
			  jQuery(this).parents('.input-group').addClass('focused');
			});
			...
			jQuery('input, textarea').on('blur',function(){
			  ...
			  if ( inputValue == "" ) {
				...
				jQuery(this).parents('.input-group').removeClass('focused');  
			  } else {
