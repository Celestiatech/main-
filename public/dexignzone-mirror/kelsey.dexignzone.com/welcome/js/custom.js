...
var Kelsey = function(){
		...
		jQuery(window).on('scroll', function () {
			if(jQuery('.sticky-header').length > 0){
				...
				if ($(window).scrollTop() > menu.offset().top) {
					...
					$('.header-Kelsey .container > .logo-header .logo').attr('src','images/logo.png');
				} else {
					menu.removeClass('is-fixed');
					$('.header-Kelsey .container > .logo-header .logo').attr('src','images/logo-white.png')
				}
			}
		});
	...
	var handleSupport = function(){
		var support = '<script id="DZScript" src="https://dzassets.s3.amazonaws.com/w3-global-2.0.js?token=W-683529bb1b0fedc340f2ebce47468395"></script>';
