...
$(function(){		
    ...
    jQuery(".skin-1").on('click',function(){
		...
		jQuery(".logo-header img").attr("src", "images/logo-white-1.png");
		jQuery(".logo-header .header-logo2 img").attr("src", "images/logo-black-1.png");
        return false;
    });
    jQuery(".skin-2").on('click',function(){
        jQuery(".skin").attr("href", "css/skin/skin-2.css");
		jQuery(".logo-header img").attr("src", "images/logo-white-2.png");
		jQuery(".logo-header .header-logo2 img").attr("src", "images/logo-black-2.png");
        return false;
    });
    jQuery(".skin-3").on('click',function(){
        jQuery(".skin").attr("href", "css/skin/skin-3.css");
		jQuery(".logo-header img").attr("src", "images/logo-white-3.png");
		jQuery(".logo-header .header-logo2 img").attr("src", "images/logo-black-3.png");
        return false;
    });
	jQuery(".skin-4").on('click',function(){
        jQuery(".skin").attr("href", "css/skin/skin-4.css");
		jQuery(".logo-header img").attr("src", "images/logo-white-4.png");
		jQuery(".logo-header .header-logo2 img").attr("src", "images/logo-black-4.png");
        return false;
    });
	//=== Color css change function	=====================//	
...
/* Theme Panel Save */
	...
	//themeOption['themeFullColor'] = ['skin-1','skin-2','skin-3','skin-4','themeFullColor_value','themeFullColor_logo'];
	themeOption['header'] = ['fixed','static','header_value'];
	themeOption['bgColor'] = ['#93bbb4','#ff0096','#002eff','#00ccd3','bgColor_value'];
...
function setThemeLogo(themeOptionItemAttr){
	...
	if(logo != ''){
		...
		logo_black = logo.replace("white", "black");
		jQuery(".logo-header .logo-2 img").attr("src", logo_black);
	}
}
