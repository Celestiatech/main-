...
const TOOL_ICON_MAP: Record<string, { iconClass: string; color: string }> = {
  "json-formatter": { iconClass: "fa-solid fa-code", color: "#e67e00" },
  "json-validator": { iconClass: "fa-solid fa-square-check", color: "#e67e00" },
  ...
  "css-minifier": { iconClass: "fa-brands fa-css3-alt", color: "#e67e00" },
  "javascript-minifier": { iconClass: "fa-brands fa-js", color: "#ca8a04" },
  "uuid-generator": { iconClass: "fa-solid fa-fingerprint", color: "#475569" },
  "api-response-viewer": { iconClass: "fa-solid fa-server", color: "#cc5500" },
  "word-counter": { iconClass: "fa-solid fa-file-lines", color: "#e67e00" },
  "character-counter": { iconClass: "fa-solid fa-font", color: "#7c3aed" },
  "case-converter": { iconClass: "fa-solid fa-arrow-down-a-z", color: "#e67e00" },
  ...
  "image-compressor": { iconClass: "fa-solid fa-file-image", color: "#e67e00" },
  ...
  "screenshot-to-image": { iconClass: "fa-solid fa-camera", color: "#e67e00" },
  "blur-image-tool": { iconClass: "fa-solid fa-droplet", color: "#6366f1" },
  "watermark-tool": { iconClass: "fa-solid fa-stamp", color: "#0284c7" },
  "pdf-to-word": { iconClass: "fa-solid fa-file-word", color: "#e67e00" },
  ...
  "pdf-page-extractor": { iconClass: "fa-solid fa-file-export", color: "#e67e00" },
  "pdf-password-remover": { iconClass: "fa-solid fa-unlock", color: "#ca8a04" },
  "meta-tag-generator": { iconClass: "fa-solid fa-tags", color: "#e67e00" },
  ...
  "website-audit-tool": { iconClass: "fa-solid fa-globe", color: "#e67e00" },
  ...
  "gradient-generator": { iconClass: "fa-solid fa-fill-drip", color: "#e67e00" },
  ...
  "timestamp-converter": { iconClass: "fa-solid fa-clock", color: "#e67e00" },
                ...
                <div className={styles.toolCardTop}>
                  <div className={styles.toolIconWrap}>
                    <i
                      ...
                      style={{ color: TOOL_ICON_MAP[tool.slug]?.color ?? "#e67e00" }}
                      aria-hidden="true"
                    />
                  </div>
