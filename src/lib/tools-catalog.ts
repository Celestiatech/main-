...
export const TOOLS: ToolItem[] = [
  ...
  { slug: "da-pa-checker", title: "DA PA Checker", category: "seo-tools", description: "Check domain authority, page authority, and spam score for up to 10 URLs.", status: "live" },
  ...
  { slug: "shopify-theme-generator", title: "Shopify Theme Generator", category: "generators", description: "Turn a website you own into an editable Shopify Online Store 2.0 theme.", status: "live" },
  ...
  { slug: "slug-generator", title: "Slug Generator", category: "seo-tools", description: "Turn any text into clean SEO-friendly URL slugs.", status: "live" },
  { slug: "seo-cost-calculator", title: "SEO Cost Calculator", category: "seo-tools", description: "Estimate an SEO budget range based on your goals.", status: "live" },
  { slug: "alt-tag-checker", title: "Alt Tag Checker", category: "seo-tools", description: "Find images missing alt text in your HTML.", status: "live" },
  { slug: "content-analysis", title: "Content Analysis", category: "seo-tools", description: "Score readability, structure and SEO signals in your content.", status: "live" },
  { slug: "url-redirect-checker", title: "URL Redirect Checker", category: "seo-tools", description: "Follow redirect chains and check HTTP status of any URL.", status: "live" },
  { slug: "ai-text-humanizer", title: "AI Text Humanizer", category: "seo-tools", description: "Rewrite stiff AI text into natural, human-sounding copy.", status: "live" },
  { slug: "ai-content-detector", title: "AI Content Detector", category: "seo-tools", description: "Estimate how likely text was written by AI.", status: "live" },
  { slug: "pagespeed-insights", title: "PageSpeed Insights", category: "seo-tools", description: "Measure core web vitals and performance scores.", status: "live" },
